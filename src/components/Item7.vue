<template>
    ...
    <!-- Item -->
            <div class="each-item">
              ...
              <b-button v-b-modal.modal-multi-7 class="btn-sm btn-primary mb-3" @click="newsDetails(news.articles[0])">Read More</b-button>
            </div>
            
    <!-- Content of first layer modal -->
            <b-modal id="modal-multi-7" size="lg"ok-only no-stacking>
