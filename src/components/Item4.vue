<template>
    ...
    <div class="item">
      <div class="row mt-5">
        <div class="col-md-12" >
<h3 class="subject">Entertainment</h3>
    <!-- Item -->
            <div class="each-item">
              ...
              <b-button v-b-modal.modal-multi-4 class="btn-sm btn-primary mb-3" @click="newsDetails(news.articles[0])">Read More</b-button>
            </div>
            
    <!-- Content of first layer modal -->
            <b-modal id="modal-multi-4" size="lg"ok-only no-stacking>
...
export default {
  ...
  created(){
    axios.get('https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=e351d24b45df4eb09e93286cca7833c5')
